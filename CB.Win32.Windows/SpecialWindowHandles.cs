namespace CB.Win32.Windows
{
    ...
    public enum SpecialWindowHandles
    {
        ...
        /// <summary>
        ///     Places the window above all non-topmost windows. The window maintains its topmost position even when
        ///     it is deactivated.
        /// </summary>
        Topmost = -1,

        /// <summary>
        ///     Places the window above all non-topmost windows (that is, behind all topmost windows). This flag has
