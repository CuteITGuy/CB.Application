namespace CB.Win32.Pixels
{
    ...
    public enum RasterOperations: uint
    {
        ...
        /// <summary>
        ///     Combines the inverted colors of the destination rectangle with the colors of the source rectangle by
        ...
        /// <summary>
        ///     Merges the colors of the inverted source rectangle with the colors of the destination rectangle by
        ...
        ///     rectangle by using the Boolean OR operator. The result of this operation is combined with the colors
        ///     of the destination rectangle by using the Boolean OR operator.
        /// </summary>
        PatPaint = 0x00FB0A09,

        /// <summary>
        ///     Combines the colors of the brush currently selected in hdcDest, with the colors of the destination
        ...
        /// <summary>
        ///     Includes any windows that are layered on top of your window in the resulting image. By default, the
        ///     image only contains your window. Note that this generally cannot be used for printing device contexts.
        ///     <para>
        ///         Capture window as seen on screen. This includes layered windows such as WPF windows with
